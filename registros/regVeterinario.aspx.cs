...
public partial class regVeterinario : System.Web.UI.Page
{
    ...
    protected void InserirRegisto(object sender, EventArgs e)
    {
        ...
        StrInsert = "INSERT INTO Veterinario( dni, nombre, apellidos, numContacto,fecNac ,residencia ,regimen ,numColegiado , usuario)";
        StrInsert += "VALUES( @dni, @nombre, @apellidos, @numContacto, @fecNac , @residencia , @regimen , @numColegiado , @usuario)";
        ...
        Cmd.Parameters.AddWithValue("@numColegiado", numColegiado.Text);
