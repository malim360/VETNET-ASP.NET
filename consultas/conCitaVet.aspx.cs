...
public partial class consultas_conCitaVet : System.Web.UI.Page
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        string SqlStr3 = "SELECT * FROM Cita WHERE dniVeterinario=@dni AND pendiente='true'";
        ...
        if (Dados3.HasRows)
        {
            saida.Text += "<table><tr><td><strong>DNI Cliente</strong></td><td><strong>DNI Veterinario</strong></td><td><strong> Num Registro</strong></td><td><strong>fecha</strong></td><td><strong>Hora</strong></td> <td> Aceptar </td> <td> Rechazar </td> </tr>";
            while (Dados3.Read())
            {
                ...
                saida.Text += "<td> <a href=conCitaVet2.aspx?Id=" + Dados3.GetValue(0) + "&Accion=aceptar>Aceptar </a></td>";
                saida.Text += "<td> <a href=conCitaVet2.aspx?Id=" + Dados3.GetValue(0) + "&Accion=rechazar>Rechazar </a></td></tr>";
